...
impl Fp8E4m3fnQuantize {
    ...
    pub fn launch(
        ...
        launch_kernel!(function, cfg, stream, [x.raw(), n_nope])
    }
...
impl CompressorStateShuffleR4 {
    ...
    pub fn launch(
        ...
        launch_kernel!(function, cfg, stream, [state_kv.raw(), state_score.raw(), width])
    }
}
...
impl F16Roundtrip {
    ...
    pub fn launch(
        ...
        launch_kernel!(function, cfg, stream, [x.raw(), n])
    }
}
